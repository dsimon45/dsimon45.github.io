...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
        ...
        },{id: "dropdown-about-this-website",
              title: "About this Website",
              description: "",
              section: "Dropdown",
              handler: () => {
                window.location.href = "/about-this-website/";
              },
            },{id: "dropdown-wrong-david",
              title: "Wrong David?",
              description: "",
              section: "Dropdown",
              handler: () => {
                window.location.href = "/wrong-david/";
              },
        ...
        handler: () => {
          ...
          title: 'MentalMath',
          description: "Improving my mental math.",
          section: "Projects",handler: () => {
              window.location.href = "/projects/mentalmath/";
